...
Use the Transformation Service to transform rights data to a valid xml format.

The Transformation Service API requires authentication, see
...
application clients that use the Transformation Service APIs:

+ [API reference](https://github.com/openpermissions/transformation-srv/blob/master/documents/apiary/api.md)
