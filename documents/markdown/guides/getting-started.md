...
From the perspective of an external client, OPP enables the following
functionality:
...
+ **Hub Key** &mdash; a uniform resource locator generated by the OPP
  to locate an entity
+ **Asset** &mdash; an entity having potentially licenceable content
