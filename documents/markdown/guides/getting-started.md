...
+ Hub Key &mdash; a unique resource locator generated by the Open
  Permissions Platform to locate an entity
+ Asset &mdash; an entity having potentially licensable content
+ Offer &mdash; terms of use offered for an entity
+ Agreement &mdash; an offer agreed between a licensor and user
+ Licensor &mdash; a party that has the right to offer assets
+ Open Licensing &mdash; the ODRL profile used by the Open Permissions Platform

Because both OPP and the Open Licensing ODRL profile are open source, you
